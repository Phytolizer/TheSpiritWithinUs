...
char* expand(char* input, int bufsize) {
    static const SHORTHAND shorthands[] = {
        {"n", "go north"},   {"s", "go south"},       {"w", "go west"},
        {"e", "go east"},    {"go n", "go north"},    {"go s", "go south"},
        {"go w", "go west"}, {"go e", "go east"},     {"x A", "examine "},
        {"g A", "get "},     {"t A", "take "},        {"o A", "open "},
        {"c A", "close "},   {"l A", "look "},        {"l", "look"},
        {"i", "inventory"},  {"info", "information"}, {"h", "help"},
        {"z", "wait "},      {"q", "quit "},          {"A", NULL}};
    const SHORTHAND* sh;
