...
.executeQuit: the player can now select Yes or No. It shows the number of moves
and remaining health. .attack, defense, kill, drive, read, burn and eat added to
the parser. .endNumber and fox are controlled within the loop (check end.c and
fox.c).
*/
