...
extern const char* toggleToilet(void);
extern const char* toggleFridge(void);
extern const char* toggleBoxPhoto(void);
extern const char* toggleAidKit(void);

extern const char* toggleClosetDoor(void);
extern const char* toggleShedDoor(void);
extern const char* toggleGarageDoor(void);
extern const char* toggleGarageDoorLock(void);

extern void toggleLamp(void);
extern void toggleCarEngine(void);
