...
int executeQuestion(void) {
    printf("I am just a computer game, I have no real answer to your "
           "questions.\n");
    return true;
}
...
int executeVoice(void) {
    printf("Your throat hurts, and you can't make any sound other than a "
           "wheeze.\n");
    return true;
}
...
int executeListen(void) {
    if (player->location->sector == 4) {
        printf("The rooms are silent. You hear the ticking of a clock but you "
        ...
        printf("You are too shaken to hear anything other than your own "
               "heartbeat.\n");
    } else {
